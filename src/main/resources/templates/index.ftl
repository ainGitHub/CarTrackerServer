...
<head>
  ...
  <title>Оценка страхования</title>
  <!-- Bootstrap core CSS-->
  <link href="/resources/static/vendor/bootstrap/css/bootstrap.min.css" rel="stylesheet">
  <!-- Custom fonts for this template-->
  <link href="/resources/static/vendor/font-awesome/css/font-awesome.min.css" rel="stylesheet" type="text/css">
               ...
               <div class="col-xl-3 col-sm-6 mb-3">
                   <div class="card text-white bg-primary o-hidden h-100">
                       <div class="card-body">
                           ...
                           <div class="mr-5">${driver.name} - ${driver.score} баллов</div>
                       </div>
